...
<section class="posts-container">
    ...
    <div class="box-container">
        ...
        $status = 'active';
        $select_posts->bind_param("ss", $author, $status);
        ...
        if($result_posts->num_rows > 0){
            while($fetch_posts = $result_posts->fetch_assoc()){
                ...
                <form class="box" method="post">
                    ...
                    <div class="icons">
                        <a href="view_post.php?post_id=<?= htmlspecialchars($post_id); ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_comments; ?>)</span></a>
