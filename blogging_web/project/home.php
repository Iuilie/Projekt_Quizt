    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            if($result_profile->num_rows > 0){
                ...
                $result_user_comments = $count_user_comments->get_result();
                $total_user_comments = $result_user_comments->num_rows;

                $count_user_likes = $conn->prepare("SELECT * FROM `likes` WHERE user_id = ?");
                $count_user_likes->bind_param("i", $user_id);
                $count_user_likes->execute();
                $result_user_likes = $count_user_likes->get_result();
                $total_user_likes = $result_user_likes->num_rows;
                ?>
                ...
                <div class="flex-btn">
                    <a href="../project/user_likes.php" class="option-btn">likes</a>
                    <a href="../project/user_comments.php" class="option-btn">comments</a>
                </div>
                <?php
            }else{
                ?>
        ...
        <div class="box">
            ...
            <div class="flex-box">
                ...
                <a href="../project/all_category.php" class="btn">view all</a>
            </div>
        </div>
            ...
            <div class="flex-box">
                ...
                if($result_authors->num_rows > 0){
                    while($fetch_authors = $result_authors->fetch_assoc()){
                        ?>
                        <a href="../project/author_posts.php<?= htmlspecialchars($fetch_authors['name']); ?>" class="links"><?= htmlspecialchars($fetch_authors['name']); ?></a>
                        <?php
                    }
                }else{
                ...
                ?>
                <a href="../project/authors.php" class="btn">view all</a>
            </div>
        </div>
